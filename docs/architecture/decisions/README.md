...
| [ADR-010](ADR-010-live-traci-agent-engine.md) | Drive the simulation live through TraCI instead of pre-generating routes |
| [ADR-011](ADR-011-demand-statistics-file-and-thinning.md) | Drive spawning from a committed, labelled statistics file using time-varying arrivals |
